...
cityInput.addEventListener("mouseleave", cityDisplay2);
function cityDisplay2() {
    var city = cityInput.value;
...
function weaterInfoDownloaded(data) {
    //document.write("<hr />");
    //document.write("weatherInfoDownloaded: " + "<br>");
    //document.write("weatherInfoDownloaded: " + data.query.results.channel.item.condition.temp + "°" );
    ...
    function cityDisplay() {
        var city = cityInput.value;
        cityName2.innerHTML = city + ': ' + data.query.results.channel.item.condition.temp + "°";
    }
